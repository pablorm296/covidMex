-   [Instalación :package:](#instalacion-package)
-   [Uso :question:](#uso-question)
    -   [Básicos](#basicos)
    -   [Avanzado](#avanzado)
    -   [Generando gráficas a partir de los
        datos](#generando-graficas-a-partir-de-los-datos)
-   [Fuentes](#fuentes)
-   [Build & Test Info
    :construction\_worker:](#build-test-info-construction_worker)
-   [Changelog](#changelog)
    -   [0.1.0 - 18/03/2020](#section)
    -   [0.2.0 - 19/03/2020](#section-1)
    -   [0.2.1 - 19/03/2020](#section-2)
    -   [0.3.0 - 23/03/2020](#section-3)
    -   [0.3.1 - 24/03/2020](#section-4)
-   [Licencia](#licencia)

Un paquete para obtener datos oficiales sobre casos de Covid-19 en
México y el mundo. Creado por [Pablo
Reyes](https://twitter.com/pablorm296). Última actualizacion: **Wed Mar
25 09:26:47 2020**
...
el reporte del día de casos confirmados
(`type = "suspect", date = "today"`). Si todavía no se publica el
reporte diario, `getData` descargará el reporte del día anterior y
notificará al usuario por medio de una `warning`.
...
-   Redacción, “Datos abiertos sobre casos de Coronavirus COVID-19 en
    ...
    <a href="https://serendipia.digital/2020/03/datos-abiertos-sobre-casos-de-coronavirus-covid-19-en-mexico/" class="uri">https://serendipia.digital/2020/03/datos-abiertos-sobre-casos-de-coronavirus-covid-19-en-mexico/</a>,
...
-   Katia Guzmán Martínez, “covid19\_mex: Publicación de datos oficiales
    ...
    de 2020,
    <a href="https://github.com/guzmart/covid19_mex" class="uri">https://github.com/guzmart/covid19_mex</a>,
    consultado el 18 de marzo de 2020.
...
<td style="text-align: left;">linux-gnu</td>
...
<td style="text-align: left;">77875</td>
<td style="text-align: left;">R</td>
<td style="text-align: left;">R version 3.6.3 (2020-02-29)</td>
<td style="text-align: left;">Holding the Windsock</td>
</tr>
</tbody>
</table>
